 ...
 *
 * Esta clase se encarga de pedir los datos de un complejo, ingresar un numero no mayor a 10 de salas mostrar el mapa de la sala mediante especificación de identificador, reservar una silla en una sala, calcular el valor recaudado por venta de boletas en un día por cada sala del complejo, y permite también registrar a los usuarios vendedor y administrador que pertenecerá al complejo.
 *
...
//        salas = new Sala[numSalas];
	...
	/**
	 * Este método se encarga de crear un objeto de tipo Sala, pedir los datos del mismo y validar que el objeto de la sala no esté repetido mediante su ID
	 *
	 * @author José Manuel Quintero Rodríguez
	 */
