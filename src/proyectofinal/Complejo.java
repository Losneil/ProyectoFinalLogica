...
/**
   ...
   *
   * Esta clase se encarga de pedir los datos de un complejo, ingresar un numero no mayor a 10 de salas mostrar el mapa de la sala mediante especificación de identificador,
   * reservar una silla en una sala, calcular el valor recaudado por venta de boletas en un día por cada sala del complejo,
