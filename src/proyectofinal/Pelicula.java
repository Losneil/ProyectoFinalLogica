...
public class Pelicula {
	 ...
	 public void pedirInfoPelicula() {
			...
			/**
			 * Ciclo que indica que el usuario no debe ingresar un número distinto a los establecidos.
			 *
			 * @author Jose Manuel Quintero Rodriguez.
			 *
			 */
	 ...
	 /**
	  * Este método, permite obtener el nombre del genero de la película de acuerdo al caso que se halla escogido en el menú de generos.
	  *
	  * @author Jose Manuel Quintero Rodriguez
	  * @author Juan Ángel Riaño Quintero
	  *
