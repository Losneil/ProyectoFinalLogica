...
public class Empresa {
	...
	/**
	 * Método constructor de la clase en donde se asignarán los tamaños de los arreglos Pelicula[] y Complejo[].
...
//            users[i].contrasena = JOptionPane.showInputDialog("Registre contraseña para cajero " + (i + 1));
	...
	/**
	 * Este método se encarga de insertar las peliculas en la programación, siempre y cuando estas se encuentren activas para agregarlas a la programacion
	 *
	 * @author José Manuel Quintero Rodríguez
	 */
...
//	}
	...
	public void mostrarInfoPelicula(String nombre) {
		...
		// Si al recorrer el ciclo no se encontró ninguna película con el nombre especificado.
	...
	public void actualizarDatosPelicula(String nombre) {
		...
		int  i, opcionCambio, controladorAlertas = 0;
		boolean existencia = false;
		
		for (i = 0; i < peliculas.length; i++) {  // Recorremos el arreglo de objetos Pelicula.
